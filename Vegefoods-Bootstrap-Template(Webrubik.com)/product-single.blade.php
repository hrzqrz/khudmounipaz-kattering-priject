...
<html lang="en">
  <head>
	  <title>محصولات تکی سورس رایگان فروش فروت لند :: دریافت شده از وب روبیک </title>
    <meta charset="utf-8">
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="pics/product-1.jpg" class="image-popup"><img src="pics/product-1.jpg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<p>فلفل دلمه ای نیز فلفل شیرین و یا کپسایسیم هستند و در رنگ های مختلف مثل زرد، قرمز، سبز، بنفش و نارنجی موجود هستند. این سبزیجات ، بیش از 900 سال پیش در جنوب و آمریکای مرکزی پرورش داده شدند و نام فلفل را از استعمارگران اروپایی آمریکای شمالی دریافت کردند.
