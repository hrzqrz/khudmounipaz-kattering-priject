...
<html lang="en">
<head>
    <title>صورت حساب سورس رایگان فروش فروت لند :: دریافت شده از وب روبیک </title>
    <meta charset="utf-8">
                ...
                <div class="cart-list">
                    <table class="table">
                        ...
                        <tr class="text-center">
                            ...
                            <td class="image-prod">
                                <div class="img" style="background-image:url(pics/product-3.jpg);"></div>
                            </td>

                            <td class="product-name">
                                <h3>لوبیا سبز</h3>
                                <p>لوبیا سبز دارای مقدار قابل توجهی آنتی اکسیدان است و حتی دارای مزایای قلبی عروقی می
                                    باشد. لوبیا سبز ،منبع غنی از چربی های امگا 3 است. کاروتنوئید و فلاونوئید موجود در
                        ...
                        <tr class="text-center">
                            ...
                            <td class="image-prod">
                                <div class="img" style="background-image:url(pics/product-4.jpg);"></div>
                            </td>

                            <td class="product-name">
                                <h3>کلم بنفش</h3>
                                <p>کلم، سرشار از ویتامین C است. این ویتامین هم نوع دیگری از آنتی‌اکسیدان‌ها است. به همین
