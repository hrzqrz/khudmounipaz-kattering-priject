...
<html lang="en">
  <head>
	  <title>لیست علاقه مندی سورس رایگان فروش فروت لند :: دریافت شده از وب روبیک </title>
    <meta charset="utf-8">
	  ...
	  <div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="ftco-nav">
			  <ul class="navbar-nav ml-auto">
				  ...
				  <li class="nav-item"><a href="about.html" class="nav-link">در مورد ما</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">لیست علاقه مندی های من</h1>
          </div>
        </div>
      </div>
    </div>
	    				...
	    				<table class="table">
						    ...
						    <tbody>
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(pics/product-1.jpg);"></div></td>
						        
						        <td class="product-name">
						        	<h3>فلفل دلمه ای</h3>
						        	<p>فلفل دلمه ای برای بالا بردن رشد مو برای سلامتی</p>
						        </td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(pics/product-2.jpg);"></div></td>
						        
						        <td class="product-name">
						        	<h3>توت فرنگی</h3>
						        	<p>توت فرنگی برای تنظیم میزان قندخون</p>
						        </td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(pics/product-3.jpg);"></div></td>
						        
						        <td class="product-name">
						        	<h3>لوبیا سبز</h3>
						        	<p>لوبیا سبز غنی از فیبر</p>
						        </td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(pics/product-4.jpg);"></div></td>
						        
						        <td class="product-name">
						        	<h3>کلم بنفش</h3>
						        	<p>کلم بنفش برای تقویت سیستم ایمنی</p>
						        </td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(pics/product-5.jpg);"></div></td>
						        
						        <td class="product-name">
						        	<h3>گوجه فرنگی</h3>
						        	<p>گوجه برای مقابله با تاثیرات بد استعمال دخانیات</p>
						        </td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(pics/product-6.jpg);"></div></td>
						        
						        <td class="product-name">
						        	<h3>کلم بروکلی</h3>
						        	<p>کلم بروکلی برای کمک به هضم</p>
						        </td>
			  ...
			  <div class="col-md">
				  <div class="ftco-footer-widget mb-4">
					  ...
					  <div class="block-23 mb-3">
						  <ul>
							  <li><span class="icon icon-map-marker"></span><span class="text">ایران - شیراز - فروت لند</span>
							  </li>
