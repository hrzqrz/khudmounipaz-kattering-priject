...
<html lang="en">
<head>
    <title>در مورد سورس رایگان فروش فروت لند :: دریافت شده از وب روبیک </title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="index.html">غذاهای گیاهی</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">خرید</a>
                    <div class="dropdown-menu" id="top-dropdown-menu" aria-labelledby="dropdown04">
                        <a class="dropdown-item" href="shop.html">خرید</a>
                        <a class="dropdown-item" href="wishlist.html">لیست علاقه مندی</a>
                        <a class="dropdown-item" href="product-single.html">محصولات تکی</a>
                        <a class="dropdown-item" href="cart.html">کارت تخفیف</a>
                        <a class="dropdown-item" href="checkout.html">سبد خرید</a>
                    </div>
                </li>
                <li class="nav-item active"><a href="about.html" class="nav-link">فروت لند</a></li>
                <li class="nav-item"><a href="blog.html" class="nav-link">بلاگ فروت لند</a></li>
                <li class="nav-item"><a href="contact.html" class="nav-link">ارتباط با ما</a></li>
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <h1 class="mb-0 bread">به سلامتی خود اهمیت دهید</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center"
                 style="background-image: url(pics/about.jpg);">
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">به وب سایت فروت لند خوش آمدین</h2>
                    </div>
                </div>
                <div class="pb-md-5">
                    ...
                    <p>درحالیکه این احتمال وجود دارد که موادغذایی ارگانیک رشدپایین تری داشته باشند نتایج نشان داد که ارزش غذایی مهمترین عامل گرایش مصرف کنندگان برای خریدومصرف این محصولات می باشد و اهمیت افزایش اگاهی مصرف کنندگان نسبت به ارزش غذایی محصولات ارگانیک درتغییررفتارهای مصرفی آنان و توسعه و گسترش تولید و مصرف موادغذایی سالم مورد تایید قرارگرفت
                    </p>
...
<section class="ftco-section ftco-no-pt ftco-no-pb py-5 bg-light">
    <div class="container py-4">
        <div class="row d-flex justify-content-center py-5">
            <div class="col-md-6">
                <h2 style="font-size: 22px;" class="mb-0">عضویت در خبرنامه فروت لند</h2>
...
<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(pics/bg_3.jpg);">
    <div class="container">
                    ...
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                            ...
                            <div class="text text-center">
                                ...
                                <span class="position">توسعه دهنده وب
 
</span>
                            </div>
                        </div>
